            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 rounded-xl bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-white/30 focus-visible:border-white/30 pr-10"
                />
                <button
                  type="button"
